  ...
  return (
    <>
      <PageHero badge="DevOps" title="Infrastructure Built for" highlight="Zero Downtime"
        ...
        gradient="from-brand-500 via-indigo-50 to-brand-600" />
      <section className="py-20 bg-white">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="w-16 h-16 rounded-3xl bg-gradient-to-br from-brand-400 to-brand-700 flex items-center justify-center shadow-xl mb-6">
                <FontAwesomeIcon icon={faInfinity} className="w-7 h-7 text-white" />
              </div>
              <h2 className="text-3xl font-black text-slate-900 mb-5">Deploy Faster, <span className="gradient-text">Break Nothing</span></h2>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[{ label: "Clusters Managed", value: "12+", gradient: "from-brand-400 to-brand-700" }, { label: "Avg Uptime", value: "99.99%", gradient: "from-brand-600 to-brand-600" }, { label: "Deploy Frequency", value: "5x/day", gradient: "from-brand-700 to-brand-600" }, { label: "MTTR", value: "< 5min", gradient: "from-brand-500 to-brand-600" }].map((stat) => (
      ...
      <section className="py-16 bg-white text-center">
        <a href="/get-a-quote" className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-brand-400 to-brand-700 text-white font-bold rounded-2xl shadow-xl hover:-translate-y-1 transition-all">
